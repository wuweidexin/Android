 ...
 *
 */
public class PeoRecPlaceSelect extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.peo_rec_placeselect);
		creatView();
	}
	/*
	 * 创建视图
	...
	private void creatView() {
		areaSpin = (Spinner)findViewById(R.id.peo_rec_choseArea);
		biotopeSpin = (Spinner)findViewById(R.id.peo_rec_choseBiotope);
		chose = (Button)findViewById(R.id.peo_rec_chose);
		back = (Button)findViewById(R.id.peo_rec_back);
		...
		chose.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				intent = new Intent(PeoRecPlaceSelect.this,PeoRecordbuilding.class);
		...
		back.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				intent = new Intent(PeoRecPlaceSelect.this, AllMenuItem.class);
				startActivity(intent);
			}
		});
	}
